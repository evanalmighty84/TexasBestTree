...
class Bucket {
     ...
     * ```
     * @returns { accessUrl: string } An object containing the pre-signed URL.
     */
    generatePreSignedUrl(key, urlAction, signedUrlOptions = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (urlAction.toLocaleUpperCase() === REQ_METHOD.get && signedUrlOptions.versionId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const metaData = (uploadOptions === null || uploadOptions === void 0 ? void 0 : uploadOptions.metaData)
                ? Object.entries(uploadOptions === null || uploadOptions === void 0 ? void 0 : uploadOptions.metaData)
                    ...
                    .join('')
                : '';
            const headers = Object.assign({ compress: (uploadOptions === null || uploadOptions === void 0 ? void 0 : uploadOptions.compress) || 'false', 'Content-Type': (uploadOptions === null || uploadOptions === void 0 ? void 0 : uploadOptions.contentType) || contentType, 'expires-after': (uploadOptions === null || uploadOptions === void 0 ? void 0 : uploadOptions.ttl) || '', overwrite: (uploadOptions === null || uploadOptions === void 0 ? void 0 : uploadOptions.overwrite) || '' }, (metaData ? { 'x-user-meta': metaData } : {}));
            const param = {};
            if (uploadOptions === null || uploadOptions === void 0 ? void 0 : uploadOptions.extractUpload) {
                param.extractAndUpload = uploadOptions === null || uploadOptions === void 0 ? void 0 : uploadOptions.extractUpload;
            }
            const signParam = (yield __classPrivateFieldGet(this, _Bucket_util, "f").getBucketSignature());
            if (signParam !== undefined) {
                url += '/_signed';
            ...
            if (typeof body === 'string') {
                const bufferData = Buffer.from(body, 'utf-8');
                body = stream_1.Readable.from(bufferData);
            }
