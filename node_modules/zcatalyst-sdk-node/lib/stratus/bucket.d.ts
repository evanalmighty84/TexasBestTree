...
import { IStratusObjects, IStratusBucket, IStratusCorsRes, IStratusObjectDetails, IStratusPagedObjectOptions, IStratusPreSignedUrlOptions, IStratusPutObjectOptions, IStratusUnzipRes, IStratusObjectRenameRes, IStratusMultipartSummaryRes, IStratusInitiateUpload, IStratusUnzipStatus, IStratusObjectCopyRes, IStratusInitiateObjectOptions, IStratusUploadPartOptions } from '../utils/pojo/stratus';
...
export declare class Bucket {
     ...
     */
    generatePreSignedUrl(key: string, urlAction: 'PUT' | 'GET', signedUrlOptions?: IStratusPreSignedUrlOptions): Promise<{
        accessUrl: string;
    }>;
    /**
     ...
     *   - `expiresAfter` (string): The time after which the object will expire (in seconds).
