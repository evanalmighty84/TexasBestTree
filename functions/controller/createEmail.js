...
// Route handler: first multer, then your logic
exports.createEmail = [
    ...
    async (req, res) => {
        try {
            ...
            // Sanitize phone, upload image if present, etc.
      ...
      `;
          ...
          <img src="${imageUrl}" alt="Uploaded tree" style="max-width:100%;height:auto;"/>
          </p>`;
            }
